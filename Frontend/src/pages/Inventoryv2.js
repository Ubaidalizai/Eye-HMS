...
function Inventory() {
  ...
  const handleMoveItem = (item, quantity) => {
    dispatch(moveItemAPI({ item, quantity }));
  };
              ...
              {products.map((element, index) => (
                <tr key={element._id}>
                  ...
                  <td className="whitespace-nowrap px-4 py-2 text-gray-700">
                    ...
                    <button
                      onClick={() => handleMoveItem(element, 1)}
                      className="bg-blue-500 hover:bg-blue-700 text-white font-bold p-1 rounded ml-2"
                    >
                      Move 1
                    </button>
                  </td>
