        ...
        <div className="bg-white p-8 rounded-xl shadow-md max-w-md w-full">
          <div className="text-center mb-6">
            ...
            <p className="text-gray-600 mt-2">
              You need to be logged in to view this financial data. Your session may have expired.
            </p>
          </div>
          <div className="space-y-4">
            <button
              onClick={() => (window.location.href = "/login")} // Redirect to login page using browser navigation
