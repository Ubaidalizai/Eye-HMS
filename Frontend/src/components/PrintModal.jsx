...
const PrintModal = ({
  ...
  const printContent = isMultipleRecords ? (
    <div className='print:p-0'>
      ...
      <h4 className='text-base font-semibold mb-3 print:text-sm'>{title}</h4>
      ...
      <div className='mb-4 print:mb-2 bg-gray-50 p-3 rounded print:bg-transparent print:p-1'>
        <div className='grid grid-cols-2 gap-2 text-sm print:text-xs'>
          ...
          <p>
            ...
            {selectedRecord.records[0]?.doctor?.firstName}{' '}
            {selectedRecord.records[0]?.doctor?.lastName}
          </p>
          <p>
            <strong>Date:</strong>{' '}
        ...
        <table className='w-full text-sm border-collapse border border-gray-300 print:text-xs'>
          <thead>
            <tr className='bg-gray-100 print:bg-gray-200'>
              <th className='border border-gray-300 px-2 py-1 text-left font-semibold print:px-1 print:py-0.5'>
                Type
              </th>
              <th className='border border-gray-300 px-2 py-1 text-left font-semibold print:px-1 print:py-0.5'>
                Price
          ...
          <tfoot>
            <tr className='bg-gray-50 print:bg-gray-100'>
              <td
                colSpan='3'
                className='border border-gray-300 px-2 py-1 print:px-1 print:py-0.5 font-semibold text-right'
              >
                Grand Total:
              </td>
